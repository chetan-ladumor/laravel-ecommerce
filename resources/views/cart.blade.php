                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{asset($product->model->image) }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" width="50px" height="50px">
                                            </a>
                                            <div class="cart-product-content">
                                                <h6 class="cart-product-title">{{$product->name
                                                }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="product-price">
                                        <h5 class="price amount">{{$product->price
                                                }}</h5>
                                    </td>
